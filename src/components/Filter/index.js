...
const Filter = () => {
  return (
    <div className='flex flex-col gap-1 flex-1 '>
      <div className='bg-[#F4F4F4] h-[83px] px-[38px] py-[30px]'>
        <h3 className='font-bold text-xl leading-[20px]'>Filters</h3>
      </div>
      <div className='bg-[#F4F4F4] flex flex-col gap-[33px] px-[38px] py-[32px]'>
        {/* branches */}
        <div className='flex flex-col gap-[22px] text-lg'>
          <h3 className='text-xl'>Branches</h3>
          <div class="ml-[20px] options flex flex-col gap-5">
            <label title="all">
